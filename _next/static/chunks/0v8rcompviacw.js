...
Se houver dor abdominal forte, sem al\xedvio e associada a v\xf4mito ou parada de elimina\xe7\xe3o de gases e fezes, procure atendimento agora — isso n\xe3o \xe9 g\xe1s.`,procedencia:r}];e.s(["ARTIGOS",0,s],96809);let i={gestacao:"Gestação",exames:"Exames",parto:"Parto","pos-parto":"Pós-parto",bebe:"Bebê",vergonha:"Sem vergonha de perguntar"};function t(e){return`/biblioteca/artigo/?slug=${e}`}function n(e){return`${e} min de leitura`}let d=["var(--bloco-rosa)","var(--bloco-agua)","var(--bloco-limao)","var(--bloco-polen)","var(--bloco-malva)"];function m({artigo:e,indice:r}){return(0,a.jsxs)(o.default,{href:t(e.slug),className:"tap flex w-[15.5rem] flex-col justify-between rounded-[var(--radius-lg)] p-4",style:{background:d[r%d.length]},children:[(0,a.jsx)("span",{className:"text-[length:var(--title-3)] font-semibold leading-snug",style:{color:"var(--bloco-tinta)"},children:e.titulo}),(0,a.jsx)("span",{className:"mt-6 text-[length:var(--body-sm)]",style:{color:"var(--bloco-tinta)",opacity:.85},children:n(e.leitura)})]})}e.s(["LinhaArtigo",0,function({artigo:e}){return(0,a.jsxs)(o.default,{href:t(e.slug),className:"tap block rounded-[var(--radius-md)] bg-card p-4 hover:bg-card-alt",children:[(0,a.jsx)("p",{className:"text-[length:var(--title-3)] font-medium leading-snug text-strong",children:e.titulo}),(0,a.jsx)("p",{className:"mt-1.5 text-[length:var(--body)] leading-relaxed text-muted",children:e.resumo}),(0,a.jsxs)("p",{className:"mt-2.5 text-[length:var(--body-sm)] text-muted",children:[i[e.categoria]," · ",n(e.leitura)]})]})},"ORDEM_CATEGORIA",0,["gestacao","exames","parto","pos-parto","bebe"],"ROTULO_CATEGORIA",0,i,"TrilhoArtigos",0,function({slugs:e}){let o=e.map(e=>s.find(a=>a.slug===e)).filter(e=>!!e);return 0===o.length?null:(0,a.jsx)("div",{className:"rail no-scrollbar pb-1",children:o.map((e,o)=>(0,a.jsx)(m,{artigo:e,indice:o},e.slug))})},"acharArtigo",0,function(e){return e?s.find(a=>a.slug===e):void 0},"hrefArtigo",0,t,"semAcento",0,function(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()},"tempoDeLeitura",0,n],36468)},55959,e=>{"use strict";var a=e.i(46400),o=e.i(55967),r=e.i(9910),s=e.i(77103),i=e.i(41447),t=e.i(38286),n=e.i(233),d=e.i(55822),m=e.i(36468);let c=e=>`cf.diario.${e}`,x=[{id:"bem",rotulo:"Bem",descricao:"Dia comum, nada atrapalhando"},{id:"oscilando",rotulo:"Oscilando",descricao:"Teve hora boa e hora ruim"},{id:"dificil",rotulo:"Difícil",descricao:"Custou para atravessar o dia"}],u=["Enjoo","Azia","Cansaço","Dor nas costas","Inchaço","Insônia","Dor de cabeça","Ansiedade","Falta de ar","Contração de treino","Intestino preso","Tontura"],l=["sono-na-gestacao","azia-e-refluxo","enjoo-na-gestacao","inchaco-na-gestacao","saude-emocional-na-gestacao","atividade-fisica-na-gestacao","intestino-hemorroida-e-gases"];function p(){return(0,a.jsxs)("main",{className:"px-[var(--gutter-screen)] pt-8",children:[(0,a.jsx)(t.Esqueleto,{className:"h-8 w-28"}),(0,a.jsx)(t.Esqueleto,{className:"mt-4 h-5 w-3/4"}),(0,a.jsx)(t.Esqueleto,{className:"mt-6 h-96 w-full rounded-[var(--radius-lg)]"})]})}e.s(["default",0,function(){let{paciente:e,pronto:g}=(0,i.useDados)(),v=e?.id??"anon",[f,h]=(0,o.useState)([]),[b,q]=(0,o.useState)(null),[j,N]=(0,o.useState)([]),[z,C]=(0,o.useState)(""),[A,S]=(0,o.useState)(!1),y=(0,s.hojeIso)(),E=(0,o.useRef)(null);(0,o.useEffect)(()=>{if(E.current===v)return;E.current=v;let e=function(e){try{let a=localStorage.getItem(c(e));if(!a)return[];let o=JSON.parse(a);return Array.isArray(o)?o:[]}catch{return[]}}(v);h(e);let a=e.find(e=>e.data===(0,s.hojeIso)());q(a?.estado??null),N(a?.sintomas??[]),C(a?.nota??""),S(!1)},[v]);let O=(0,o.useMemo)(()=>[...f].filter(e=>e.data!==y).sort((e,a)=>a.data.localeCompare(e.data)).slice(0,7),[f,y]);return g&&e?"suspensa"===e.status?(0,a.jsx)(d.JornadaSuspensa,{paciente:e}):(0,a.jsxs)("main",{children:[(0,a.jsxs)("header",{className:"flex items-center justify-between gap-3 px-[var(--gutter-screen)] pb-2 pt-6",children:[(0,a.jsx)("h1",{className:"text-[length:var(--title-1)] font-semibold text-strong",children:"Saúde"}),(0,a.jsx)(n.BotaoTema,{})]}),(0,a.jsx)("p",{className:"px-[var(--gutter-screen)] text-[length:var(--body-lg)] leading-relaxed text-body",children:"Um registro por dia, do tamanho que der. Na consulta, isto vale mais que a memória de três semanas."}),(0,a.jsxs)("section",{className:"mt-6 px-[var(--gutter-screen)]",children:[(0,a.jsxs)(t.Card,{children:[(0,a.jsx)("p",{className:"text-[length:var(--caption)] font-medium uppercase tracking-[0.12em] text-muted",children:(0,s.dataPorExtenso)(y)}),(0,a.jsx)("h2",{className:"mt-2 text-[length:var(--title-2)] font-semibold text-strong",children:"Como foi o seu dia?"}),(0,a.jsx)("div",{className:"mt-4 grid gap-2",children:x.map(e=>{let o=b===e.id;return(0,a.jsxs)("button",{onClick:()=>{q(e.id),S(!1)},"aria-pressed":o,className:(0,t.cx)("tap flex min-h-14 w-full flex-col justify-center rounded-[var(--radius-md)] px-4 py-2.5 text-left",o?"bg-invert text-page":"bg-inset hover:bg-accent-quiet"),children:[(0,a.jsx)("span",{className:(0,t.cx)("text-[length:var(--body-lg)] font-medium leading-snug",!o&&"text-strong"),children:e.rotulo}),(0,a.jsx)("span",{className:(0,t.cx)("text-[length:var(--body-sm)] leading-snug",o?"opacity-75":"text-muted"),children:e.descricao})]},e.id)})}),(0,a.jsx)("h3",{className:"mt-7 text-[length:var(--title-3)] font-semibold text-strong",children:"O que apareceu"}),(0,a.jsx)("p",{className:"mt-1 text-[length:var(--body-sm)] text-muted",children:"Marque quantos quiser. Nenhum deles é motivo de susto por si só."}),(0,a.jsx)("div",{className:"mt-3 flex flex-wrap gap-2",children:u.map(e=>{let o=j.includes(e);return(0,a.jsx)("button",{onClick:()=>{S(!1),N(a=>a.includes(e)?a.filter(a=>a!==e):[...a,e])},"aria-pressed":o,className:(0,t.cx)("tap inline-flex min-h-11 items-center rounded-[var(--radius-pill)] px-4","text-[length:var(--body-sm)] font-medium",o?"bg-invert text-page":"bg-inset text-body hover:bg-accent-quiet"),children:e},e)})}),(0,a.jsx)("div",{className:"mt-7",children:(0,a.jsx)(t.Campo,{rotulo:"Quer escrever alguma coisa?",dica:"Uma linha basta. Horário, o que você tinha comido, o que aliviou.",children:(0,a.jsx)(t.AreaTexto,{value:z,onChange:e=>{C(e.target.value),S(!1)},placeholder:"A azia veio de novo depois do jantar…",maxLength:600,rows:3})})}),(0,a.jsx)("div",{className:"mt-5 flex items-center gap-3",children:(0,a.jsx)(t.Botao,{onClick:()=>{if(!b)return;let e={data:y,estado:b,sintomas:j,nota:z.trim()},a=[...f.filter(e=>e.data!==y),e];h(a),S(!0);try{localStorage.setItem(c(v),JSON.stringify(a))}catch{}},disabled:!b,largo:!0,children:f.some(e=>e.data===y)?"Atualizar o dia":"Guardar o dia"})}),A&&(0,a.jsx)("p",{role:"status",className:"mt-3 text-[length:var(--body-sm)] font-medium text-brand",children:"Guardado. Você pode voltar e mudar quantas vezes quiser."})]}),(0,a.jsx)("p",{className:"mt-3 px-1 text-[length:var(--body-sm)] leading-relaxed text-muted",children:"O diário fica só neste aparelho. Ninguém da equipe lê o que você escreve aqui — mostre na consulta se quiser."})]}),(0,a.jsx)("section",{className:"mt-8 px-[var(--gutter-screen)]",children:(0,a.jsxs)("div",{className:"rounded-[var(--radius-md)] bg-danger-surface px-4 py-3.5",children:[(0,a.jsx)("p",{className:"text-[length:var(--body)] font-semibold text-danger-ink",children:"Sintoma que assusta não é para o diário."}),(0,a.jsx)("p",{className:"mt-1 text-[length:var(--body)] leading-relaxed text-body",children:"Sangramento, dor forte, perda de líquido, febre ou o bebê parado: use o botão vermelho de sinais de alerta e procure a maternidade. Não espere a próxima consulta."})]})}),O.length>0&&(0,a.jsxs)("section",{className:"mt-8 px-[var(--gutter-screen)]",children:[(0,a.jsx)(t.TituloSecao,{children:"Dias anteriores"}),(0,a.jsx)("ul",{className:"grid gap-2",children:O.map(e=>(0,a.jsxs)("li",{className:"rounded-[var(--radius-md)] bg-card p-4",children:[(0,a.jsxs)("div",{className:"flex flex-wrap items-baseline gap-x-3 gap-y-1",children:[(0,a.jsx)("span",{className:"text-[length:var(--body-lg)] font-medium text-strong",children:x.find(a=>a.id===e.estado)?.rotulo}),(0,a.jsx)("span",{className:"text-[length:var(--body-sm)] text-muted",children:(0,s.quando)(e.data)})]}),e.sintomas.length>0&&(0,a.jsx)("div",{className:"mt-2 flex flex-wrap gap-1.5",children:e.sintomas.map(e=>(0,a.jsx)(t.Chip,{children:e},e))}),e.nota&&(0,a.jsx)("p",{className:"mt-2 text-[length:var(--body)] leading-relaxed text-body",children:e.nota})]},e.data))})]}),(0,a.jsxs)("section",{className:"mt-10",children:[(0,a.jsx)("div",{className:"px-[var(--gutter-screen)]",children:(0,a.jsx)(t.TituloSecao,{acao:{rotulo:"Biblioteca",href:"/biblioteca"},children:"Para ler quando bater"})}),(0,a.jsx)(m.TrilhoArtigos,{slugs:l})]}),(0,a.jsx)("section",{className:"mt-8 px-[var(--gutter-screen)]",children:(0,a.jsx)(t.Card,{alt:!0,children:(0,a.jsxs)("div",{className:"flex items-start gap-3",children:[(0,a.jsx)(r.NotebookPen,{size:20,strokeWidth:1.75,className:"mt-0.5 shrink-0 text-brand","aria-hidden":!0}),(0,a.jsxs)("div",{className:"min-w-0",children:[(0,a.jsx)("p",{className:"text-[length:var(--body-lg)] font-medium leading-snug text-strong",children:"Se algo se repete há dias, conte"}),(0,a.jsx)("p",{className:"mt-1.5 text-[length:var(--body)] leading-relaxed text-body",children:"Enjoo que não passa, azia toda noite, insônia na semana inteira: isso tem manejo e não precisa esperar a consulta chegar."}),(0,a.jsx)("div",{className:"mt-4",children:(0,a.jsx)(t.BotaoLinha,{href:"/equipe",children:"Escrever para a equipe"})})]})]})})}),(0,a.jsx)("div",{className:"h-6"})]}):(0,a.jsx)(p,{})}])}]);