...
Se houver dor abdominal forte, sem al\xedvio e associada a v\xf4mito ou parada de elimina\xe7\xe3o de gases e fezes, procure atendimento agora — isso n\xe3o \xe9 g\xe1s.`,procedencia:r}];e.s(["ARTIGOS",0,s],96809);let i={gestacao:"Gestação",exames:"Exames",parto:"Parto","pos-parto":"Pós-parto",bebe:"Bebê",vergonha:"Sem vergonha de perguntar"};function t(e){return`/biblioteca/artigo/?slug=${e}`}function n(e){return`${e} min de leitura`}let d=["var(--bloco-rosa)","var(--bloco-agua)","var(--bloco-limao)","var(--bloco-polen)","var(--bloco-malva)"];function m({artigo:e,indice:r}){return(0,a.jsxs)(o.default,{href:t(e.slug),className:"tap flex w-[15.5rem] flex-col justify-between rounded-[var(--radius-lg)] p-4",style:{background:d[r%d.length]},children:[(0,a.jsx)("span",{className:"text-[length:var(--title-3)] font-semibold leading-snug",style:{color:"var(--bloco-tinta)"},children:e.titulo}),(0,a.jsx)("span",{className:"mt-6 text-[length:var(--body-sm)]",style:{color:"var(--bloco-tinta)",opacity:.85},children:n(e.leitura)})]})}e.s(["LinhaArtigo",0,function({artigo:e}){return(0,a.jsxs)(o.default,{href:t(e.slug),className:"tap block rounded-[var(--radius-md)] bg-card p-4 hover:bg-card-alt",children:[(0,a.jsx)("p",{className:"text-[length:var(--title-3)] font-medium leading-snug text-strong",children:e.titulo}),(0,a.jsx)("p",{className:"mt-1.5 text-[length:var(--body)] leading-relaxed text-muted",children:e.resumo}),(0,a.jsxs)("p",{className:"mt-2.5 text-[length:var(--body-sm)] text-muted",children:[i[e.categoria]," · ",n(e.leitura)]})]})},"ORDEM_CATEGORIA",0,["gestacao","exames","parto","pos-parto","bebe"],"ROTULO_CATEGORIA",0,i,"TrilhoArtigos",0,function({slugs:e}){let o=e.map(e=>s.find(a=>a.slug===e)).filter(e=>!!e);return 0===o.length?null:(0,a.jsx)("div",{className:"rail no-scrollbar pb-1",children:o.map((e,o)=>(0,a.jsx)(m,{artigo:e,indice:o},e.slug))})},"acharArtigo",0,function(e){return e?s.find(a=>a.slug===e):void 0},"hrefArtigo",0,t,"semAcento",0,function(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()},"tempoDeLeitura",0,n],36468)},70785,e=>{"use strict";var a=e.i(46400),o=e.i(55967),r=e.i(53342),s=e.i(94964),i=e.i(96809),t=e.i(77103),n=e.i(41447),d=e.i(38286),m=e.i(16228),c=e.i(55822);function x(e,r){return e.split(/(\*\*[^*]+\*\*)/g).filter(Boolean).map((e,s)=>e.startsWith("**")&&e.endsWith("**")?(0,a.jsx)("strong",{children:e.slice(2,-2)},`${r}-${s}`):(0,a.jsx)(o.Fragment,{children:e},`${r}-${s}`))}function u({corpo:e}){let o=e.trim().split(/\n{2,}/);return(0,a.jsx)("div",{className:"prose-body",children:o.map((e,o)=>{let r=e.split("\n").filter(e=>""!==e.trim());return e.startsWith("## ")?(0,a.jsx)("h2",{style:{marginTop:"var(--space-8)"},className:"text-[length:var(--title-2)] font-semibold text-strong",children:x(e.slice(3).trim(),`h${o}`)},o):r.every(e=>e.trimStart().startsWith("- "))?(0,a.jsx)("ul",{className:"grid list-none gap-2 pl-0",children:r.map((e,r)=>(0,a.jsxs)("li",{className:"relative pl-5",children:[(0,a.jsx)("span",{"aria-hidden":!0,className:"absolute left-0 top-[0.7em] h-1.5 w-1.5 rounded-full bg-accent"}),x(e.trimStart().slice(2),`l${o}-${r}`)]},r))},o):r.every(e=>/^\s*\d+\.\s/.test(e))?(0,a.jsx)("ol",{className:"grid list-none gap-3 pl-0",children:r.map((e,r)=>{let[,s,i]=e.trimStart().match(/^(\d+)\.\s+([\s\S]*)$/)??[];return(0,a.jsxs)("li",{className:"flex gap-3",children:[(0,a.jsx)("span",{"aria-hidden":!0,className:"tabular w-6 shrink-0 pt-[0.15em] text-[length:var(--body-sm)] font-semibold text-brand",children:s}),(0,a.jsx)("span",{className:"min-w-0",children:x(i??e,`o${o}-${r}`)})]},r)})},o):(0,a.jsx)("p",{children:x(e.replace(/\n/g," "),`p${o}`)},o)})})}var l=e.i(36468);function p(){let{paciente:e,pronto:o}=(0,n.useDados)(),x=(0,l.acharArtigo)((0,r.useSearchParams)().get("slug"));if(!o||!e)return(0,a.jsx)(g,{});if("suspensa"===e.status)return(0,a.jsx)(c.JornadaSuspensa,{paciente:e});if(!x)return(0,a.jsxs)("main",{children:[(0,a.jsx)(m.CabecalhoTela,{titulo:"Biblioteca",voltarPara:"/biblioteca"}),(0,a.jsx)("div",{className:"px-[var(--gutter-screen)] pt-6",children:(0,a.jsx)(d.Vazio,{icone:s.BookOpen,titulo:"Este texto não está mais aqui",descricao:"O endereço pode ter mudado desde que você salvou o link. A biblioteca inteira continua no mesmo lugar.",acao:{rotulo:"Voltar para a biblioteca",href:"/biblioteca"}})})]});let p=i.ARTIGOS.filter(e=>e.categoria===x.categoria&&e.slug!==x.slug).slice(0,2);return(0,a.jsxs)("main",{children:[(0,a.jsx)(m.CabecalhoTela,{titulo:l.ROTULO_CATEGORIA[x.categoria],voltarPara:"/biblioteca"}),(0,a.jsxs)("article",{className:"px-[var(--gutter-screen)] pt-2",children:[(0,a.jsxs)("header",{children:[(0,a.jsxs)("div",{className:"flex flex-wrap items-center gap-2",children:[(0,a.jsx)(d.Chip,{tom:"rosa",children:l.ROTULO_CATEGORIA[x.categoria]}),(0,a.jsx)("span",{className:"text-[length:var(--body-sm)] text-muted",children:(0,l.tempoDeLeitura)(x.leitura)})]}),(0,a.jsx)("h1",{className:"display mt-4 text-[32px] text-strong",children:x.titulo}),(0,a.jsx)("p",{className:"mt-3 max-w-[var(--max-prose)] text-[length:var(--body-lg)] leading-relaxed text-muted",children:x.resumo})]}),(0,a.jsx)("div",{className:"mt-8",children:(0,a.jsx)(u,{corpo:x.corpo})}),(0,a.jsx)("footer",{className:"mt-10",children:(0,a.jsxs)(d.Card,{alt:!0,children:[(0,a.jsxs)("p",{className:"text-[length:var(--body)] font-semibold text-strong",children:["Revisado por ",x.procedencia.aprovadoPor]}),(0,a.jsxs)("p",{className:"mt-1 text-[length:var(--body-sm)] text-muted",children:["Última revisão em ",(0,t.dataPorExtenso)(x.procedencia.aprovadoEm)," · próxima prevista para ",(0,t.dataPorExtenso)(x.procedencia.revisarEm)]}),(0,a.jsx)("p",{className:"mt-3 text-[length:var(--body)] leading-relaxed text-body",children:"Este texto é orientação geral e não substitui a consulta. O que vale para a sua gestação é o que a Dra. Cristiane avaliar com você."})]})})]}),p.length>0&&(0,a.jsxs)("section",{className:"mt-10 px-[var(--gutter-screen)]",children:[(0,a.jsx)(d.TituloSecao,{acao:{rotulo:"Ver tudo",href:"/biblioteca"},children:"Sobre o mesmo assunto"}),(0,a.jsx)("ul",{className:"grid gap-2",children:p.map(e=>(0,a.jsx)("li",{children:(0,a.jsx)(l.LinhaArtigo,{artigo:e})},e.slug))})]})]})}function g(){return(0,a.jsxs)("main",{className:"px-[var(--gutter-screen)] pt-8",children:[(0,a.jsx)(d.Esqueleto,{className:"h-5 w-24 rounded-full"}),(0,a.jsx)(d.Esqueleto,{className:"mt-5 h-9 w-full"}),(0,a.jsx)(d.Esqueleto,{className:"mt-2 h-9 w-2/3"}),(0,a.jsx)(d.Esqueleto,{className:"mt-8 h-4 w-full"}),(0,a.jsx)(d.Esqueleto,{className:"mt-2 h-4 w-full"}),(0,a.jsx)(d.Esqueleto,{className:"mt-2 h-4 w-5/6"})]})}e.s(["default",0,function(){return(0,a.jsx)(o.Suspense,{fallback:(0,a.jsx)(g,{}),children:(0,a.jsx)(p,{})})}],70785)}]);